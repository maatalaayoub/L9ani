...
export default function Settings() {
    const { 
        ...
        allowMessages, setAllowMessages
    } = useSettings();
    const { user } = useAuth();
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-[#0f172a] transition-colors duration-300">
            <main className="max-w-4xl mx-auto p-6 pt-24 md:p-12 md:pt-28">
                ...
                <div className="space-y-8">
                    ...
                    {/* Notifications & Privacy Sections - Only visible when logged in */}
                    {user ? (
                    <>
                    ...
                    {/* Privacy Section - Only visible when logged in */}
                    <div className="bg-white/80 dark:bg-[#1e293b]/50 backdrop-blur-xl rounded-2xl border border-gray-200/50 dark:border-gray-800/50 p-8 shadow-xl shadow-gray-200/20 dark:shadow-black/20">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="p-2 rounded-lg bg-green-100 dark:bg-green-500/10 text-green-600 dark:text-green-400">
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                {[
                                    { value: 'everyone', label: t('privacy.allowMessages.everyone'), desc: t('privacy.allowMessages.everyoneDesc') },
                                    { value: 'reports_only', label: t('privacy.allowMessages.reportsOnly'), desc: t('privacy.allowMessages.reportsOnlyDesc') },
                                    { value: 'nobody', label: t('privacy.allowMessages.nobody'), desc: t('privacy.allowMessages.nobodyDesc') },
                                ].map((option) => (
                                    <label
                                        key={option.value}
                                    ...
                                    >
                                        <input
                                            ...
                                            onChange={() => setAllowMessages(option.value)}
