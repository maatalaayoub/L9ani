...
export default function HomePage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0f1e] overflow-hidden">
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-12 sm:p-16 text-center">
                        {/* Background Pattern */}
            ...
            <section className="py-12 border-t border-gray-200 dark:border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-16 text-gray-400 dark:text-gray-500">
