                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        >
                                            <div className="relative">
                                                ...
                                                {isAdmin && (
                                                    <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full flex items-center justify-center border-2 border-white dark:border-gray-800 shadow-lg">
