        ...
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0f1e] overflow-hidden">
            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
                    <div className="text-center max-w-4xl mx-auto" ref={heroRef}>
                        <div ref={badgeRef} style={animations.fadeDown(badgeVisible)} className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 dark:bg-blue-900/30 rounded-full mb-8">
                            <span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></span>
                            <span className="text-sm font-medium text-blue-700 dark:text-blue-300">{t('hero.badge')}</span>
                        </div>

                        <h1 style={animations.fadeUp(heroVisible)} className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                            {t('hero.title')}
                            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
                                {t('hero.titleHighlight')}
                            </span>
                        </h1>
                        <p style={{ ...animations.fadeUp(heroVisible), transitionDelay: '0.1s' }} className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
                            {t('hero.subtitle')}
                        </p>

                        <div style={{ ...animations.fadeUp(heroVisible), transitionDelay: '0.2s' }} className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                        ...
                        <div ref={statsRef} style={animations.fadeUp(statsVisible)} className="grid grid-cols-3 gap-8 max-w-lg mx-auto">
            ...
            <section className="py-20 bg-white dark:bg-gray-900/50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div ref={howItWorksHeaderRef} style={animations.fadeUp(howItWorksHeaderVisible)} className="text-center mb-16">
                        <span className="text-blue-600 dark:text-blue-400 font-semibold text-sm uppercase tracking-wider">{t('howItWorks.label')}</span>
                        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mt-2 mb-4">{t('howItWorks.title')}</h2>
                        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">{t('howItWorks.subtitle')}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div ref={step1Ref} style={animations.staggerChild(step1Visible, 0)} className="relative group">
                            ...
                            <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 h-full transition-transform duration-300 ease-out group-hover:-translate-y-1">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">{t('howItWorks.step1.title')}</h3>
                                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{t('howItWorks.step1.description')}</p>
                            </div>
                        </div>
                        ...
                        <div ref={step2Ref} style={animations.staggerChild(step2Visible, 0.15)} className="relative group">
                            ...
                            <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 h-full transition-transform duration-300 ease-out group-hover:-translate-y-1">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">{t('howItWorks.step2.title')}</h3>
                                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{t('howItWorks.step2.description')}</p>
                            </div>
                        </div>
                        ...
                        <div ref={step3Ref} style={animations.staggerChild(step3Visible, 0.3)} className="relative group">
                            ...
                            <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 h-full transition-transform duration-300 ease-out group-hover:-translate-y-1">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">{t('howItWorks.step3.title')}</h3>
                                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{t('howItWorks.step3.description')}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800/50 dark:to-gray-900">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div ref={categoriesHeaderRef} style={animations.fadeUp(categoriesHeaderVisible)} className="text-center mb-16">
                        <span className="inline-block px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full text-sm font-semibold mb-4">{t('categories.label')}</span>
                    ...
                    <div ref={categoriesGridRef} style={animations.fadeUp(categoriesGridVisible)} className="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6">
                        <div className="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 ease-out border border-gray-100 dark:border-gray-700 hover:border-red-200 dark:hover:border-red-800 hover:-translate-y-1">
                            ...
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{t('categories.person.title')}</h3>
                        ...
                        <div className="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 ease-out border border-gray-100 dark:border-gray-700 hover:border-pink-200 dark:hover:border-pink-800 hover:-translate-y-1">
                            ...
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{t('categories.pets.title')}</h3>
                        ...
                        <div className="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 ease-out border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-800 hover:-translate-y-1">
                            ...
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{t('categories.documents.title')}</h3>
                        ...
                        <div className="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 ease-out border border-gray-100 dark:border-gray-700 hover:border-purple-200 dark:hover:border-purple-800 hover:-translate-y-1">
                            ...
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{t('categories.electronics.title')}</h3>
                        ...
                        <div className="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 ease-out border border-gray-100 dark:border-gray-700 hover:border-amber-200 dark:hover:border-amber-800 hover:-translate-y-1">
                            ...
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{t('categories.keys.title')}</h3>
                        ...
                        <div className="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 ease-out border border-gray-100 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 hover:-translate-y-1">
                            ...
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{t('categories.other.title')}</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-400">{t('categories.other.description')}</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-white dark:bg-gray-900/50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div ref={impactHeaderRef} style={animations.fadeUp(impactHeaderVisible)} className="text-center mb-16">
                        <span className="text-blue-600 dark:text-blue-400 font-semibold text-sm uppercase tracking-wider">{t('impact.label')}</span>
                        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mt-2 mb-4">{t('impact.title')}</h2>
                        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">{t('impact.subtitle')}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div ref={testimonial1Ref} style={animations.staggerChild(testimonial1Visible, 0)} className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 transition-transform duration-300 ease-out hover:-translate-y-1">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold">{t('impact.testimonial1.initial')}</div>
                                <div>
                        ...
                        <div ref={testimonial2Ref} style={animations.staggerChild(testimonial2Visible, 0.15)} className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 transition-transform duration-300 ease-out hover:-translate-y-1">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-teal-500 rounded-full flex items-center justify-center text-white font-bold">{t('impact.testimonial2.initial')}</div>
                                <div>
                        ...
                        <div ref={testimonial3Ref} style={animations.staggerChild(testimonial3Visible, 0.3)} className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 transition-transform duration-300 ease-out hover:-translate-y-1">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center text-white font-bold">{t('impact.testimonial3.initial')}</div>
                                <div>
            ...
            <section className="py-12 border-t border-gray-200 dark:border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div ref={trustRef} style={animations.fadeUp(trustVisible)} className="flex flex-wrap items-center justify-center gap-8 sm:gap-16 text-gray-400 dark:text-gray-500">
            ...
            {/* Login Dialog */}
            <LoginDialog isOpen={isLoginDialogOpen} onClose={() => setIsLoginDialogOpen(false)} initialTab={initialTab} />
        </div>
    );
}
